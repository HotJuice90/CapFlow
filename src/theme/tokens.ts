...
const semantic = {
  ...
  // серо-зелёный.
  //
  // Важно: он должен быть светлее ВЕРХНЕЙ точки градиента роста (#2CE296), а
  // не лежать между ней и positive — иначе совпадает с серединой активного
  // столбика, и выбранный перестаёт читаться на фоне остальных (так было
  // с #45CE95). Поэтому это осветлённый #2CE296, а не смесь с positive.
  positiveLight: '#8FE3C0',
  negative: '#E5484D',
  warning: '#F2A900',
  info: '#3E63DD',
};
