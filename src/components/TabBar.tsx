...
const THEME = {
  ...
  dark: {
    ...
    // Вилка нащупана с обеих сторон: на 0.55 сквозь тонировку пробивался
    // светлый фон и бар уходил в серо-синюю муть, на 0.88 блюра не видно
    // вовсе — глухая плашка. Сидим между, ближе к прозрачному; читаемость
    // добираем не плотностью, а контрастом иконок и рамки. База (38,46,76)
    // светлее исходной (30,37,62) — тёмный бар просил чуть больше воздуха.
    tintGradient: ['rgba(38,46,76,0.64)', 'rgba(38,46,76,0.52)'] as const,
    tint: 'dark' as const,
