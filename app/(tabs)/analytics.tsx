...
const styles = StyleSheet.create({
  ...
  heroGrowthPill: { borderRadius: tokens.radius.pillSmall, paddingHorizontal: 7, paddingVertical: 3 },
  ...
  heroPeriodChip: { alignItems: 'center', justifyContent: 'center', height: 25, paddingHorizontal: tokens.spacing.tight, borderRadius: tokens.radius.pillSmall },
  ...
  heroRatePill: { borderRadius: tokens.radius.pillSmall, paddingHorizontal: 8, paddingVertical: 8 },
